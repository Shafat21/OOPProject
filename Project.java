...
public class Project extends JFrame 
{
    ...
    public Project()
    {
        ...
        Icon Online1 = new ImageIcon( getClass().getResource( "SE.png" ) );
        Button1 = new JButton( "Programmes of Software Engineering", Online1 );

        add( Button1 );

        Icon Online2 = new ImageIcon( getClass().getResource( "CSE.png" ) );
        Button2 = new JButton( "Programmes of Computer Science Engineering", Online2 );
